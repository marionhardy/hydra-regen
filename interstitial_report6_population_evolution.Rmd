...
-   Blast transcription factors with the g id !
-   Do population number evolution over time (not just neurons!)
-   Cluster with 0.1 resolution
-   Aligning to the 105 genome
...
seurat_f@meta.data <-
  ...
  mutate(attr_clusters=
           ...
           ifelse(seurat_clusters == "9", "unknown/zymogen?",
